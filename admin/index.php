...
<head>
    ...
    <meta name="description" content="Poll Admin page to manage online polls, monitor results, and control voting system efficiently. Secure and easy poll management.">
    <meta name="keywords" content="poll admin, online voting system, poll management, create polls, manage votes, poll results">
    ...
    <div class="total-div">
        <div class="main-div">
            <div class="header-div no-select">
                ...
                <a draggable="false" href="../" class="poll-now-text">Pollnow</a>

...
<head>
    ...
    <meta name="description" content="Edit your profile details, update personal information, and manage account settings securely.">
    <meta name="keywords" content="edit profile, update account, user settings, manage profile, account information">
    ...
    <main>
        <div class="total-div">
            <div class="edit-profile-div">
                ...
                <form class="inputs-form" method="POST" action="../profile/">
                    <label>
                        Name
